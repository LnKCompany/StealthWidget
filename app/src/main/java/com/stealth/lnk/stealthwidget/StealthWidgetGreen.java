 ...
 */
public class StealthWidgetGreen extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            settingDTO.setName("Green");
            settingDTO = settingDAO.selectOne(settingDTO);
            Intent intent = null;

            RemoteViews remoteView = new RemoteViews(context.getPackageName(), R.layout.stealth_widget_green);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        this.onUpdate(context, manager, manager.getAppWidgetIds(new ComponentName(context, StealthWidgetGreen.class)));
